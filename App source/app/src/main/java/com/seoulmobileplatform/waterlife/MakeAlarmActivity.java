...
public class MakeAlarmActivity extends AppCompatActivity {
    ...
    // DB
    private final String TAG = "MakeAlarmActivity";
    ...
    // get Views
    @Bind(R.id.makealram_content1_tv_starttime)
    TextView tv_StartLabel;
    @Bind(R.id.makealram_content1_tv_endtime)
    TextView tv_EndLabel;
    @Bind(R.id.makealram_np_interval)
    ...
    private void Initialize()
    {
        ...
        systems_alarm = new Systems_Alarm(this);
        ...
        if(tv_StartLabel.getText().toString().contains("분") && tv_EndLabel.getText().toString().contains("분")) {
            ...
            if(Integer.parseInt(sTime[0]) <= Integer.parseInt(eTime[0])) {
                try {
                    ...
                    systems_db.addAlarm(requestcode, daylist, tv_StartLabel.getText().toString(), tv_EndLabel.getText().toString(), numberPicker_interval.getValue());
                    ...
                    exceptionLog.Exception_SetAlarm(e.getMessage());
                }
            }
            else
