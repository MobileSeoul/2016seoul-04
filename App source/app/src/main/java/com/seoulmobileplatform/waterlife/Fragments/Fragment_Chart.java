...
import com.seoulmobileplatform.waterlife.MyMarkerView;
...
/*===================================================
                    'Chart' Fragment
 ===================================================*/
public class Fragment_Chart extends Fragment implements OnChartValueSelectedListener {
    ...
    // DB
    private final String TAG = "Fragment_Chart";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // set dateCount
        dateCount = -Systems.getDateDay(Systems.getFarDay(0), "yyyy-MM-dd");
        Initialize_Chart(Systems.getDateDay(Systems.getFarDay(0), "yyyy-MM-dd"));
    }
    ...
    {
        int DayNum = Systems.getDateDay(Systems.getFarDay(0), "yyyy-MM-dd");
        switch (v.getId()){
    ...
    private void Initialize_Chart(int daycount)
    {
        ...
        for(int i=0; i<=daycount; i++) {
            int daysum = systems_db.getDayDrinkAmount(Systems.getFarDay(dateCount+i));
        ...
        tv_date.setText(Systems.getFarDay(dateCount) + " ~ " + Systems.getFarDay(dateCount+6));
