...
import com.seoulmobileplatform.waterlife.Fragments.Fragment_Chart;
import com.seoulmobileplatform.waterlife.Fragments.Fragment_DailyRecord;
import com.seoulmobileplatform.waterlife.Fragments.Fragment_SetNotification;
import com.seoulmobileplatform.waterlife.Fragments.Fragment_Settings;
import com.seoulmobileplatform.waterlife.Fragments.Fragment_TodayWaterDrink;
import com.seoulmobileplatform.waterlife.Systems.AlarmBootReceiver;
import com.seoulmobileplatform.waterlife.Systems.ExceptionLog;
import com.seoulmobileplatform.waterlife.Systems.LocalWeatherReceiver;
...
public class MainActivity extends AppCompatActivity  {
    ...
    public class SectionsPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            Fragment fragment = new Fragment_TodayWaterDrink();
            switch (position) {
                case 0:
                    fragment = new Fragment_SetNotification();
                    break;
                case 1:
                    fragment = new Fragment_DailyRecord();
                    break;
                case 2:
                    fragment = new Fragment_TodayWaterDrink();
                    break;
                case 3:
                    fragment = new Fragment_Chart();
                    break;
                case 4:
    ...
    private void getNFCData(Intent intent) {
        ...
        if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(getIntent().getAction())) {
            ...
            if (rawMsgs != null) {
                ...
                // add a record
                systems_db.addRecord(new String(payload));
                // Notify Data Change
                UpdateFragments();
                // Show Bade
    ...
    protected void onResume() {
        ...
        try {
            filter.addDataType("waterlife_nfc/*");
        } catch (Exception e) {
            exceptionLog.Exception_NFCWrite(e.getMessage());
        }
